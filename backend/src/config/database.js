...
if (process.env.NODE_ENV === "test") {
  console.log("🔌 Entorno de pruebas detectado. Conectando a SQLite en memoria (:memory:).");
...
const testConnection = async () => {
  try {
    ...
    console.log(`✅ Conexión establecida con éxito (${process.env.NODE_ENV === "test" ? "SQLite en memoria" : "PostgreSQL"}).`);
  } catch (error) {
